...
T_S^W=
\begin{bmatrix}
 9.99899965\times10^{-1} &  4.08174960\times10^{-3} &  1.35425346\times10^{-2} &  4.64854451\times10^{0}\\
-3.90191952\times10^{-3} &  9.99904219\times10^{-1} & -1.32788632\times10^{-2} &  6.91826166\times10^{0}\\
-1.35954385\times10^{-2} &  1.32246930\times10^{-2} &  9.99820120\times10^{-1} &  8.04989229\times10^{-2}\\
 0.00000000\times10^{0} &  0.00000000\times10^{0} &  0.00000000\times10^{0} &  1.00000000\times10^{0}
\end{bmatrix}
$$
#### 旋转矩阵校验
$R^T R$ 计算结果：
...
R^TR=
\begin{bmatrix}
1.00000000 & -1.62202564\times10^{-16} & 2.16704996\times10^{-16}\\
-1.62202564\times10^{-16} & 1.00000000 & 1.42562833\times10^{-16}\\
2.16704996\times10^{-16} & 1.42562833\times10^{-16} & 1.00000000
\end{bmatrix}
$$

行列式：
$$\det(R) = 1.0000000000000546$$
![点云配准可视化验证](pcd_val.png)
